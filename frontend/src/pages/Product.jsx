    ...
    "
        >
          ...
          <div className="flex-1 px-8 py-5 border-r border-white/20">
            <p className="text-xs font-bold uppercase text-[#213555]">What</p>
            <input
              type="text"
          ...
          >
            ...
            >
              <Heart
                ...
                color={wishlistIds.includes(product._id) ? "red" : "#374151"}
              />
            </button>
            ...
            <div className="p-5">
              ...
              <h3 className="mt-2 text-[#3E5879]">₹{product.rentPrice}/day</h3>

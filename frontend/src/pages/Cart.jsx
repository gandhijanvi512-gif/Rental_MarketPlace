...
function Cart() {
  ...
  const checkProductAvailability = async (item) => {
    try {
      ...
      const res = await api.get(`/checkavailable/${item.productId._id}`, {
        params: {
  ...
  const handleBookNow = async (item) => {
    ...
    if (!isAvailable) {
      toast.error("This product is not available for the selected dates.");
      return;
    }
              ...
              <div className="cart-left">
                ...
                <div className="cart-left-bottom">
                  <h2 className="total-price">
                    Total: ₹{calculateTotal(item).toLocaleString("en-IN")}
                  </h2>
              ...
              <div className="cart-right">
                ...
                <div className="price-info">
                  <span>
                    ...
                    Rent Price: ₹{item.productId?.rentPrice}
                    /day
                  </span>
                  ...
                  >
                    {availability[item._id].isAvailable ? (
                      ...
                      <>
                        ...
                        <p>{availability[item._id].message}</p>
            ...
            <div className="summary-body">
              ...
              <div className="summary-item">
                ...
                <p className="item-value">
                  ₹{rentTotal.toLocaleString("en-IN")}
                </p>
              </div>
